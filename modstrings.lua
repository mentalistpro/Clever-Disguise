...
STRINGS.MERM_TALK_FIND_FOOD_UNTRANSLATED         = {"Glort grolt flut.", "Glurt florpy flut!"}
STRINGS.MERM_TALK_FIND_FOOD                      = {"This do fine.", "Find something tasty!"}

STRINGS.MERM_TALK_HELP_CHOP_WOOD_UNTRANSLATED    = {"Grop, groppy, grop!", "Glort blut, florp!"}
STRINGS.MERM_TALK_HELP_CHOP_WOOD                 = {"Chop, choppy, chop!", "Work hard, florp!"}
STRINGS.MERM_TALK_HELP_MINE_ROCK_UNTRANSLATED    = {"Wult wop, florty flort!", "Glort blut, florp!"}
STRINGS.MERM_TALK_HELP_MINE_ROCK                 = {"Break rock, easy!", "Work hard, florp!"}
STRINGS.MERM_TALK_HELP_HAMMER_UNTRANSLATED       = {"Florph! Florph!", "Glort blut, florp!"}
STRINGS.MERM_TALK_HELP_HAMMER                    = {"Smash! Smash!", "Work hard, florp!"}
